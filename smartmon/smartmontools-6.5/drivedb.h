 ...
 */
  ...
  { "OpenSSD Jasmine", 
    ...
    "-v 243,raw48,Num_Write_Sectors_(High) "
    "-v 244,raw48,Num_Read_Sectors_(High) "
    "-v 245,raw48,Num_GC_Counts "
    "-v 246,raw48,Num_Erased_Blocks "
    "-v 247,raw48,Num_Copybacked_Pages "
    "-v 248,raw48,Num_Hot_Blocks "
    "-v 249,raw48,Num_Cold_blocks "
    "-v 250,raw48,Num_Normal_blocks "
  },
/*
}; // builtin_knowndrives[]
 */
